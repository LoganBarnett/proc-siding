{
  description = "proc-siding — GPU pressure monitor for garage-queue workers";
  inputs = {
  ...
  outputs = { self, nixpkgs, rust-overlay, crane, metalps }@inputs: let
    ...
    workspaceCrates = {
      ...
      # CLI application
      cli = {
        name = "proc-siding-cli";
        binary = "proc-siding";
        description = "GPU pressure monitor";
      };
      # CRATE:cli:end
  ...
  in {
    ...
    devShells = forAllSystems (system: {
      default = (pkgsFor system).mkShell {
        ...
        shellHook = ''
          echo "proc-siding development environment"
          echo ""
